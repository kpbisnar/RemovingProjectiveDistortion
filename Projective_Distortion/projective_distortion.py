...
def coordinates_world(Xi):
    ...
    world = [[Xi[0][0],Xi[0][1],1.0]]
    world.append([Xi[0][0]+dist,Xi[0][1],1.0])
    world.append([Xi[0][0],Xi[1][1],1.0])
    world.append([Xi[0][0]+dist,Xi[1][1],1.0])
...
def show_points(Xi,Xw,img):
    ...
    ax[0].add_patch(p3)
    ax[0].add_patch(p4)
    rect= np.array[[Xi[0][0],Xi[0][1]], [Xi[2][0],Xi[2][1]], [Xi[3][0],Xi[3][1]], [Xi[1][0],Xi[1][1]]]
    ...
    ax[1].add_patch(p3_w)
    ax[1].add_patch(p4_w)
    rect_w= np.array[[Xw[0][0],Xw[0][1]], [Xw[2][0],Xw[2][1]], [Xw[3][0],Xw[3][1]], [Xw[1][0],Xw[1][1]]]
